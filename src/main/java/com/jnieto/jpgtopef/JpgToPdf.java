...
public class JpgToPdf {
    ...
    /**
     *
     * @param arg En la llamada se pasan dos parÃ¡metros que puede ser.
     *
     *
     * [?] [help] [ayuda] Cualquiera de estos parÃ¡metros muestra la ayuda de
     * uso del programa
     *
     * [v] [V] [vertical] Indica que los pdf que se generen tengan
     * horienztaciÃ³n vertical [h] [H] [horizontal] Indica que los pdf que se
     * generen tengan horienzaciÃ³n horizontal
     *
     * El segundo argumento es el directorio de trabajo. Se debe pasar en la
     * llamada para facilitar la programaciÃ³n automÃ¡tica de las tareas
     */
        ...
        try {
            ...
            switch (arg.length) {
                case 0:
                    ...
                    break;
                case 1:
                    // un parÃ¡metro toma como directorio de trabajo el actual
