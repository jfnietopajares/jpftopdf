 ...
 * fichero Constantes.NOMBREFICHEROPROPERTEIS en el directorio de trabajo
 * recupera los valores si no existe crea el fichero con los valores por defecto
 * puestos a puñetazos en el método
 */
public class ParametrosGenerales {
    ...
    /**
     *
     * @throws IOException Carga los valores por defecto en el objeto properties
     * y lo almacena en el fichero Constantes.CONFIGURACIONNOMBREFICHERO)
     */
    public void creaFichero() throws IOException {
        FileOutputStream salida = null;
        ArrayList<ParametroCfg> listaParametros = new ArrayList<ParametroCfg>();
